package components.blocks.card.delivery;

import static org.junit.jupiter.api.Assertions.assertEquals;

import annotations.Component;
import components.blocks.StaticComponent;
...
@Component("#root")
public class DeliveryCardForm extends StaticComponent<DeliveryCardForm> {
  ...
  public DeliveryCardForm setDate(LocalDate date) {
    return this.setDateInCalendar.apply(date, dateField);
  }
